...
def is_between_100_and_999(user_input_number):
    ...
    result = (100 <= user_input_number) and (user_input_number <= 1000)
...
def is_duplicated_number(three_digit):
    ...
    result = (three_digit[0] == three_digit[1]) and (three_digit[0] == three_digit[2]) and (three_digit[1] == three_digit[2])
    # ==================================
    return result
...
def get_not_duplicated_three_digit_number():
    ...
    if is_duplicated_number(random_number):
